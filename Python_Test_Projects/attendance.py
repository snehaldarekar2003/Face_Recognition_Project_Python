...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # Back Button
        back_btn = Button(btn_frame, command=self.back_function, text="Back", width=8, height=1, font=("verdana", 10, "bold"), fg="white", bg="darkred")
        back_btn.grid(row=1, column=0, padx=6, pady=10, sticky=W)
    ...
    def back_function(self):
        self.root.quit()  # This will close the window
        self.root.destroy()  # Destroy the window after closing
