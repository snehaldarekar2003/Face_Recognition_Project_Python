...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #refresh button
        refresh_btn = Button(btn_frame, command=self.fetch_data, text="Refresh", width=6, font=("verdana",12,"bold"), fg="white", bg="navyblue")
        ...
        #Update button
        del_btn=Button(btn_frame,command=self.action,text="Update",width=8,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        del_btn.grid(row=0,column=2,padx=6,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=6,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        ...
        back_btn.grid(row=0, column=5, padx=6, pady=10, sticky=W)
        #back_btn.lift()  # Brings the button to the top layer
    ...
    def importCsv(self):
        ...
        with open(fln) as myfile:
            ...
            for i in csvread:
                mydata.append(i)
        print("CSV Data Imported:", mydata)  # Debugging Line
