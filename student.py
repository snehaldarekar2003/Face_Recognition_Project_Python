...
class Student:
    ...
    # This part is image labels setting start 
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"C:\Users\user\Documents\Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        dep_combo["values"]=("Select Department","Computer","Electronics","Civil","Mechanical","Chemical")
        dep_combo.current(0)
        ...
        #save button
        save_btn=Button(btn_frame,command=self.add_data,text="Save",width=5,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        save_btn.grid(row=0,column=0,padx=5,pady=10,sticky=W)

        #update button
        update_btn=Button(btn_frame,command=self.update_data,text="Update",width=6,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        update_btn.grid(row=0,column=1,padx=5,pady=8,sticky=W)

        #delete button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=6,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        del_btn.grid(row=0,column=2,padx=5,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=5,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        reset_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        #take photo button
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Pic",width=8,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        ...
        back_btn = Button(btn_frame, command=self.go_back, text="Back", width=5, 
                  font=("verdana", 12, "bold"), fg="white", bg="red")
        back_btn.grid(row=0, column=6, padx=6, pady=10, sticky=W)
...
# ==================Function Decleration==============================
    ...
    # Function to go back (Close the window)
    def go_back(self):
