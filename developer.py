...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\user\Documents\Python_Test_Projects\Images_GUI\bg4.png")
        ...
        det_b1_1 = Button(bg_img,text="Shital Deshmukh",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=480,y=380,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"C:\Users\user\Documents\Python_Test_Projects\Images_GUI\m1.png")
        ...
        att_b1_1 = Button(bg_img,text="Rutuja Darekar",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=710,y=380,width=180,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"C:\Users\user\Documents\Python_Test_Projects\Images_GUI\m1.png")
        ...
        hlp_b1_1 = Button(bg_img,text="Snehal Darekar",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
